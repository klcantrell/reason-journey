...
function MexicanRestaurant$RestaurantCard(Props) {
  var info = Props.info;
  var onExitClick = Props.onExitClick;
  return React.createElement("div", {
              className: "restaurant-card"
            }, React.createElement("i", {
                  onClick: (function (e) {
                      return Curry._1(onExitClick, /* () */0);
                    })
                }, "X"), React.createElement("p", undefined, info[/* name */0]), React.createElement("img", {
                  src: info[/* url */1]
                }));
}
  ...
  return React.createElement(GetMexicanRestaurantQuery[/* make */4], {
              ...
              children: (function (param) {
                  ...
                  if (typeof result === "number") {
                    ...
                    return React.createElement("div", {
                                className: "restaurant-card"
                              }, React.createElement("p", undefined, result[0].message));
                  }
                })
            });
}
